...
def generate_next_batch(data, images_path, batch_size):
    while True:
        x_batch, y_batch = [], []
        ...
        for index in rnd_indices:
            file_name, img, angle, speed = load_image(data, images_path, index)

            new_image = preprocess_img(img)
            angle = camera_adjust(angle, speed, file_name)
